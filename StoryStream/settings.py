"""
Django settings for StoryStream project.
...
SECRET_KEY = 'django-insecure-p2=*cw+$-vz$ib!#n!rboe)nr=wdcygsiejt9z18he_#w3b64k'
...
WSGI_APPLICATION = 'StoryStream.wsgi.application'
